...
function renderBottomNav(active) {
  const items = [
    { id:'dashboard',  icon:'📊', label:'概览', href:'../dashboard/' },
    { id:'crm',        icon:'👥', label:'客户', href:'../crm/' },
    { id:'orders',     icon:'📦', label:'订单', href:'../orders/' },
    { id:'finance',    icon:'💰', label:'财务', href:'../finance/' },
    { id:'tasks',      icon:'✅', label:'任务', href:'../tasks/' },
    { id:'quotes',     icon:'💵', label:'报价', href:'../quotes/' },
    { id:'suppliers',  icon:'🏭', label:'供应商', href:'../suppliers/' },
    { id:'inventory',  icon:'📦', label:'库存', href:'../inventory/' },
  ];
  return items.map(i => `
